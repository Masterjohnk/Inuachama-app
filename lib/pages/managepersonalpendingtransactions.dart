...
class ManagePersonalPendingTransactions extends StatefulWidget {
  const ManagePersonalPendingTransactions({Key? key}) : super(key: key);

  @override
  ManagePersonalPendingTransactionsState createState() =>
      ManagePersonalPendingTransactionsState();
}

class ManagePersonalPendingTransactionsState
    extends State<ManagePersonalPendingTransactions> {
  ...
  void _populateTransactions() {
    ...
    Webservice()
        .load(Transaction.all(
            "alltransactions.php?groupCode=$userGroupCode&phone=$userPhone&scope=personal"))
        .then((trans) => {
              setState(() => {
            ...
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Pay. Code: " + transactions[index].transactionCode,
                    style: mainText(),
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Pending Transactions" " (" + (transactions.length).toString() + ")",
          style: appBarText(),
          textAlign: TextAlign.center,
        ),
        //centerTitle: true,
          ...
          Padding(
            ...
            child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText: 'Pay. code, TID, Name, or LoanID',
                    hintStyle: hiText()),
          ...
          Expanded(
            child: loadingTransactions
                ...
                : transactions.isEmpty
                    ? emptyListView("You have no pending transactions..")
                    : ListView.builder(
